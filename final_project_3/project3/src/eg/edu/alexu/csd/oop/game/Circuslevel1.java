...
public class Circuslevel1 implements World{
    ...
    int sizex,sizey;
    private static Circuslevel1 circus;
    private int y;
    private Circuslevel1(int screenwidth, int screenheight,ArrayList<String>name){
        this.shapename=name;
        ...
        this.sizey=sizey;
        String nameshape;
        System.out.print(shapename.size());
        for(int i=0; i<10; i++){
    ...
    public static Circuslevel1 getinstance(int screenwidth,int screenheight,ArrayList<String> name){
        if(circus==null){
            circus=new Circuslevel1(screenwidth,screenheight,name);
        }
        return circus;
    }
