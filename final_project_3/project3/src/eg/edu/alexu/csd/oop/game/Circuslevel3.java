...
public class Circuslevel3 implements World{
    ...
    int sizex,sizey;
    private static Circuslevel3 circus;
    
    private Circuslevel3(int screenwidth, int screenheight,ArrayList<String> name){
        this.shapename=name;
    ...
    public static Circuslevel3 getinstance(int screenwidth,int screenheight,ArrayList<String> name){
        if(circus==null){
            circus=new Circuslevel3(screenwidth,screenheight,name);
        }
        return circus;
    }
